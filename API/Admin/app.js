...
const accessMenuRouter = require('./routes/accessMenu');
const smsSlipRouter = require('./routes/smsSlip');
...
app.use('/api/access', accessMenuRouter);
app.use('/api/test', testRouter);
app.use('/api/sms_slip', smsSlipRouter);

              ...
              <section v-if="step == 1">
                ...
                <!-- <mySlides></mySlides> -->
                  ...
                  <div class="mySlides fade">
                    ...
                    <img src="https://picsum.photos/id/1037/900/400" style="width:100%"> 
                 ...
                 <form id="send-code">
                  <div id="phone-input">
                    ...
                    <input type="submit" value="กดเพื่อรับรหัสOTP" id = "btn_a"
                ...
                <hr />
                          <div  id = "regis_line">
                            ...
                            <!-- <input type="submit" value="สมัครสมาชิคด้วยเบอร์โทรศัพท์" id = "regis_phone"
                      class ="btn btn btn-gradient w-100" />
                      <hr /> -->
                      <form  id = "regis_line_2"
                      action="https://liff.line.me/1657422937-NA9PEJyj">
                      <!-- <form action="https://liff.line.me/1657422937-NA9PEJyj"> -->
                        <input type="submit" value="สมัครสมาชิกด้วยไลน์ไอดี"
                        class ="btn btn linecolor  w-100" id = "btn_b"/>
                        <!-- <a href="https://liff.line.me/1657422937-NA9PEJyj" 
                        class="btn btn linecolor  w-100">สมัครสมาชิกด้วยไลน์ไอดี</a> -->
                    <!-- </form> -->
                  </form>
                          </div>
                          <hr />
                ...
                <section>
                    <div id="otp-modal">
                      <div class="modal-content">
                        ...
                        <form id="check-code">
                          <div>
                            <input type="text" id="code" placeholder="ใส่รหัส OTP 6 หลัก" required  class ="pretty_w"/>
                          </div>
                          <div>
                            <input type="submit" value="ยืนยันรหัส OTP"  class ="pretty_x" id = "btn_x"
                            />
...
// ------------------------------------hereeeeee------------------------------------
           ...
           setTimeout(function () { 
            ...
            // verifystatus = GetVerifyResponseData['status'];
             ...
             if (GetVerifyResponseData['status'] ==  "success") 
             {
              ...
              modal_btn.remove();
              model_btn_a.remove();
              showModalStatus("การยืนยันตัวตนเรียบร้อย ปิดหน้านี้พื่อดำเนินการต่อ!", {color: "green"});
              document.getElementById("demo_x").innerHTML = "การยืนยันตัวตนสำเร็จ";
              code.value = "";
              ...
              document.getElementById("demo_x").innerHTML = "การยืนยันตัวตนไม่สำเร็จกรุณาลองอีกครั้ง!";
    ...
    // ---- Line --- 
      ...
      // ------- works - but not functional well ------ cm ------- //
      ...
      //   liff.init({
      //     liffId:'1657422937-NA9PEJyj',
      //   }).then(() =>{
      //     liff.login(
      //       // {redirectUri : "https://d08f-2405-9800-bc10-f701-78b8-b83f-8dc5-7a09.ap.ngrok.io/register"}
      //     )
      //     console.log('then')
      //   }).catch((err) => {
      //     console.log(err)
...
.linebtn{
  background: url("../../assets/btn_login_press.png") no-repeat scroll 0 0 transparent;
  cursor: pointer;
  display: flex;
  justify-content: center;
  align-items: center;

...
declare class I18nModule implements LiffModule<I18nModuleAPI> {
    name: "i18n";
    install({ internalHooks }: ModuleContext<ExtendLiffCore>): I18nModuleAPI;
